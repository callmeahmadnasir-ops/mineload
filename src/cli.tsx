...
const HELP = `
  mineload — mine any video. paste. mine. done.
  ...
  Examples
    ...
    $ mineload https://x.com/user/status/123456
...
if (args.error) {
  console.error(`mineload: ${args.error}\nTry “mineload --help” for usage.`)
  process.exit(1)
}
...
if (outcome.filepath) {
  console.log(`✓ mined → ${outcome.filepath}`)
}
